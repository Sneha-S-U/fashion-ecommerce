    ...
    <div className="card" style={{ backgroundImage: `url(${imageUrl})` }}>
      ...
      <div className="card-content">
        ...
        <div className="card-actions">
          <a href="/wishlist" className="card-btn wishlist-btn" title="Add to Wishlist">
            <FaHeart /> Wishlist
          </a>
          <a href={shareUrl} target="_blank" rel="noopener noreferrer" className="card-btn share-btn" title="Share on WhatsApp">
            <FaWhatsapp /> Share
          </a>
        </div>
      </div>
...
const CardGrid = () => (
  <section className="card-section">
    <div className="trending-header">
      ...
      <p className="trending-subtitle">Discover the most loved styles of the season</p>
    </div>
