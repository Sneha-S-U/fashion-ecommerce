...
SECRET_KEY = 'django-insecure-qh!b=4bay1+%81a79#j^ogxe(ye8kx^xyh&@gh*yted=%2pa8s'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'fashionecommerce_db',  # Your PostgreSQL database name
        'USER': 'postgres',  # Or 'my_user' if you created one
